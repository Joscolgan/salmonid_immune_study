...
while read line;
do 
grep "$line" ~/projects/2020-04-11_salmonid_immune_project/2020-04-11_orthofinder_of_immune_genes/data/2020-04-11_refseq_datasets/combined_cds_headers.txt | \
sed 's/>//g' >> "$new_name"_new_transcript_names.txt;
done < "$name";
done
