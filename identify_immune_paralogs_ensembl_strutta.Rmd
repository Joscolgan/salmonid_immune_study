...
```{r, message = FALSE}
## Load RDS:
putative_strutta_immune_genes <- readRDS(file = "results/putative_strutta_immune_genes.rds")
```
...
## Save as an object:
saveRDS(pike_comp_sub_one2many_immune_ohno,
        file = "results/pike_comp_sub_one2many_immune_ohno_strutta.rds")
```
